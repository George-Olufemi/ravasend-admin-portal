...
const badgeVariants = cva(
  "inline-flex items-center rounded-full border px-2.5 py-0.5 text-xs font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2 uppercase",
  {
    variants: {
      variant: {
        default: "border-transparent bg-green-400 text-primary-foreground hover:bg-primary/80",
        primary: "border-transparent bg-yellow-500 text-primary-foreground hover:bg-primary/80",
